...
CREATE TABLE REVIEW_STATE(
	REVIEW_STATE_NO VARCHAR2(20) NOT NULL,
	REVIEW_NO VARCHAR2(20) NOT NULL,
	USR_ID VARCHAR2(30) NOT NULL,
	SYS_ENR_ID VARCHAR2(30) NULL,
	SYS_ENR_DTTM DATE NULL
...
ALTER TABLE REVIEW_STATE
	ADD CONSTRAINT PK_REVIEW_STATE -- 상품 후기 정보 기본키
	PRIMARY KEY (
		REVIEW_STATE_NO -- 상품후기정보번호
	);

ALTER TABLE REVIEW_STATE
	ADD CONSTRAINT FK_PRODUCT_REVIEW_TO_STATE -- 상품후기 -> 상품후기정보
	FOREIGN KEY (
		REVIEW_NO -- 리뷰번호
	)
	REFERENCES PRODUCT_REVIEW ( -- 상품 후기
		REVIEW_NO -- 리뷰번호
	);
